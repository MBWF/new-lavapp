...
import { Search, Plus, Minus, Trash2, Package, ShoppingCart } from "lucide-react";
...
export function StepPieces() {
  const { data, addItem, removeItem, updateItemQuantity, getTotal } = useOrderWizard();
                      ...
                      {isAdded ? (
                        <div className="flex items-center gap-1">
                          <Button
                            ...
                            size="icon"
                            className="h-8 w-8"
                            onClick={() => updateItemQuantity(piece.id, quantity - 1)}
                          >
